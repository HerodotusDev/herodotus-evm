...
//   } else {
    ...
    proof = cached["SEPOLIA"][blockArgStr]["RECEIPT_PROOFS"][transactionIndexArgStr];
    if (!proof)
      throw new Error(
        `Receipts root at block ${blockArgStr} for transaction index  ${transactionIndexArgStr}  is not cached`
      );
  //}
