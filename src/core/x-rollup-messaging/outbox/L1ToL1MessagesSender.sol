...
import {AbstractMessagesInbox} from "../inbox/AbstractMessagesInbox.sol";

contract L1ToL1MessagesSender is AbstractMessagesSender {
    AbstractMessagesInbox public immutable messagesInbox;
    ...
    constructor(
        ...
        messagesInbox = AbstractMessagesInbox(_messagesInbox);
    }
