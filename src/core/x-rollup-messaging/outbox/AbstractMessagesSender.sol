...
abstract contract AbstractMessagesSender {
    ...
    function sendKeccakMMRTreeToL2(uint256 assignedId, uint256 aggregatorId, bytes calldata _xDomainMsgGasData) external payable {
        ...
        _sendMessage(l2Target, abi.encodeWithSignature("receiveKeccakMMR(uint256, uint256,uint256,bytes32)", assignedId, aggregatorId, mmrSize, keccakMMRRoot), _xDomainMsgGasData);
    }
